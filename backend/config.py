...
IMPORT_CHUNK_SIZE = int(os.getenv("IMPORT_CHUNK_SIZE", "2000"))
# Kept as a fallback for older deployments.  It used to reject a document
# outright once its *total* number of chunks exceeded this value; new code
# treats the limit as the number of chunks in one sequential batch instead.
IMPORT_MAX_CHUNKS = int(os.getenv("IMPORT_MAX_CHUNKS", "3"))
IMPORT_BATCH_SIZE = int(os.getenv("IMPORT_BATCH_SIZE", str(IMPORT_MAX_CHUNKS)))
